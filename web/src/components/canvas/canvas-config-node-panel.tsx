...
export function CanvasConfigNodePanel({ node, isRunning, taskActive = isRunning, active = true, inputSummary, onConfigChange, onGenerate, onStop, onComposerToggle }: CanvasConfigNodePanelProps) {

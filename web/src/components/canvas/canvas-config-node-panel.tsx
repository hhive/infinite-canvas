...
export function CanvasConfigNodePanel({ node, isRunning, taskActive, active, inputSummary, onConfigChange, onGenerate, onStop, onComposerToggle }: CanvasConfigNodePanelProps) {

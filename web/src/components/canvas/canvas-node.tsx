...
export const CanvasNode = React.memo(function CanvasNode({
    ...
    const batchCount = data.type === CanvasNodeType.Image ? Math.max(legacyBatchCount, data.metadata?.images?.length || 0) : data.type === CanvasNodeType.Text ? data.metadata?.texts?.length || 0 : 0;

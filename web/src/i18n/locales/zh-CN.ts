export default {
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "暂无可复制的提示词", infoTitle: "查看节点信息", info: "信息", removeTitle: "移除节点", retryTitle: "重新生成", queryVideoTask: "获取任务状态", queryVideoTaskTitle: "使用任务 ID 查询视频生成状态", videoTaskId: "任务 ID", saveAsset: "存资产", downloadAudio: "下载音频", downloadVideo: "下载视频", downloadImage: "下载图片", editTextTitle: "编辑文本", editText: "编辑文字", decreaseFont: "减小字号", increaseFont: "增大字号", zoomOut: "缩小", zoomIn: "放大", uploadImage: "上传图片", replaceVideo: "替换视频", uploadVideo: "上传视频", reverseVideoPrompt: "反推视频提示词", reverseVideoPromptTitle: "按关键帧反推视频提示词，并创建文本与配置节点", productionBoard: "生成制作规划表", productionBoardTitle: "创建制作规划表的提示词与配置节点，模型与 Key 在配置节点上选择", renderProductionBoard: "渲染规划板", renderProductionBoardTitle: "按文本节点里的分析 JSON 重新渲染规划板（只解析与渲染，不调用模型）", generateVideoFromPrompt: "用此提示词生成视频", generateVideoFromPromptTitle: "按这段反推提示词与制作规划表创建视频配置节点，模型与 Key 在配置节点上选择", replaceAudio: "替换音频", uploadAudio: "上传音频", nodeInfo: "节点信息", name: "名称", type: "类型", size: "尺寸", position: "位置", status: "状态", imageGroup: "图片组", imageSize: "图片大小", group: "打组", groupTitle: "用组节点包住选中节点", ungroup: "解散组", ungroupTitle: "取消节点分组" },
    ...
    auth: {
        loginTitle: "登录",
        loginSubtitle: "登录后可管理 API Key、查看使用记录与余额",
        registerTitle: "注册账号",
        registerSubtitle: "注册后即可创建 API Key 并开始生成",
        email: "邮箱",
        ...
        registrationClosedHint: "站点当前未开放注册，请稍后再试或联系站点管理员。",
        emailRequired: "请输入邮箱",
    ...
    account: {
        ...
        navRedeem: "兑换",
        loginRequired: "请先登录",
        loginRequiredHint: "登录后即可管理 API Key、查看使用记录与余额。不登录也可以在生成页直接填写自己的 API Key 使用。",
        goLogin: "去登录",
        goRegister: "注册账号",
        ...
        logoutSuccess: "已退出登录",
        logoutFailed: "退出登录失败",
        overviewGreeting: "你好，{{name}}",
        overviewBalance: "账户余额",
        overviewBalanceHint: "余额由 Sub2API 统一记账，media 生成任务实时扣减。",
        overviewCurrentKey: "当前使用中的 API Key",
        overviewCurrentKeyHint: "生成任务默认使用这个 Key。",
        overviewNoKey: "当前没有可用的 API Key",
        overviewNoKeyHint: "创建 API Key 后即可在生成页直接调用。",
        overviewShortcuts: "快捷入口",
        manageKeys: "管理 API Key",
        launchGuideHint: "该会话来自 Sub2API 菜单跳转，用户中心、Key 管理、余额与兑换都在原站，请回到 Sub2API 操作；也可以登录 media 账号后使用这里的用户中心。",
        logoutConfirm: "退出后需要重新登录才能查看用户中心。",
        overviewTodayRequests: "今日请求",
        overviewTodayCost: "今日消耗",
        overviewTotalRequests: "累计请求",
        overviewTotalCost: "累计消耗",
        keysTitle: "API Key",
        keysHint: "管理用于调用接口的 Key，可以指定其中一个作为生成任务默认使用的 Key。",
        keysCreate: "新建 API Key",
        keysName: "名称",
        keysNamePlaceholder: "给这个 Key 起个名字",
        keysGroup: "分组",
        keysGroupPlaceholder: "选择分组",
        keysStatus: "状态",
        keysQuota: "额度",
        keysUnlimited: "不限",
        keysCreatedAt: "创建时间",
        ...
        keysCurrent: "当前使用",
        keysUse: "设为当前",
        keysUseSuccess: "已切换生成任务使用的 Key",
        keysUseFailed: "切换失败",
        keysDelete: "删除",
        keysDeleteConfirm: "删除后使用该 Key 的调用会立即失效，确定删除吗？",
        keysDeleteSuccess: "API Key 已删除",
        keysDeleteFailed: "删除失败",
        keysCreateSuccess: "API Key 已创建",
        keysCreateFailed: "创建失败",
        keysUpdateSuccess: "API Key 已更新",
        keysUpdateFailed: "更新失败",
        keysNameRequired: "请输入名称",
        keysStatusActive: "启用",
        keysStatusInactive: "停用",
        keysStatusQuotaExhausted: "额度已用完",
        keysStatusExpired: "已过期",
        usageTitle: "使用记录",
        usageHint: "这里是你账号下的全部用量，包含文本、对话、图片与视频。",
        usageModel: "模型",
        usageModelPlaceholder: "全部模型",
        usageAPIKeyPlaceholder: "全部 Key",
        usageReset: "重置筛选",
        usageTime: "时间",
        usageRequests: "请求数",
        usageTokens: "Token",
        usageCost: "实际消耗",
        usageStandardCost: "标准计费",
        usageAmount: "数量",
        usageEndpoint: "Endpoint",
        usageAPIKey: "API 密钥",
        usageReasoningEffort: "推理强度",
        usageIP: "IP",
        usageGroup: "分组",
        usageRequestType: "类型",
        usageBillingMode: "计费模式",
        usageLatency: "延迟",
        usageAverageDuration: "平均耗时",
        usageModelBreakdown: "按模型统计",
        balanceTitle: "余额",
        balanceHint: "余额由 Sub2API 统一记账；赠送额度按到期时间先后优先抵扣。",
        balanceAvailable: "可用余额",
        balanceFrozen: "冻结中",
        balanceCredits: "赠送额度明细",
        balanceCreditsEmpty: "当前没有赠送额度",
        balanceCreditSource: "来源",
        balanceCreditSourceRedeem: "兑换码",
        balanceCreditSourceAdmin: "管理员发放",
        balanceCreditAmount: "总额度",
        balanceCreditRemaining: "剩余",
        balanceCreditExpires: "到期时间",
        balanceCreditNeverExpires: "不过期",
        balanceCreditStatus: "状态",
        balanceCreditStatusActive: "生效中",
        balanceCreditStatusConsumed: "已用完",
        balanceCreditStatusExpired: "已过期",
        redeemTitle: "兑换码",
        redeemHint: "输入兑换码充值余额或并发额度，兑换记录会保留在下方。",
        redeemCodePlaceholder: "请输入兑换码",
        redeemSubmit: "立即兑换",
        redeemSuccess: "兑换成功，本次获得 {{value}}",
        redeemFailed: "兑换失败",
        redeemCodeRequired: "请输入兑换码",
        redeemConfirm: "兑换码一经使用无法撤回，确定兑换吗？",
        redeemPurchase: "购买兑换码",
        redeemPurchaseHint: "在官方购码站购买后回到此处兑换。",
        redeemHistory: "兑换记录",
        redeemHistoryEmpty: "暂无兑换记录",
        redeemHistoryCode: "兑换码",
        redeemHistoryValue: "获得",
        redeemHistoryStatus: "状态",
        redeemHistoryUsed: "已兑换",
        redeemHistoryUsedAt: "兑换时间",
        redeemHistoryCreatedAt: "获取时间",
        redeemTypeBalance: "余额",
        redeemTypeConcurrency: "并发",
        groupUngrouped: "未分组",
    },
    locale: {
        zhCN: "简体中文",

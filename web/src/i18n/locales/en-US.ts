export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", mode: "Mode", modes: { frames: "First & last frame", reference: "General reference" }, chargeMode: "Billing", chargeModes: { cnt: "Per task", second: "Per second" }, resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
        ...
        text: { title: "Text settings", reasoning: "Reasoning effort", count: "Generation count", frameRate: "Frame sample rate", frameRateUnit: "fps", frameRateHint: "Applies when a reference video is attached. A higher rate samples more frames and costs more input tokens." },
    ...
    canvas: {
        ...
        nodeToolbar: { noPrompt: "No prompt to copy", infoTitle: "View node information", info: "Info", removeTitle: "Remove node", retryTitle: "Generate again", queryVideoTask: "Get task status", queryVideoTaskTitle: "Query video generation status by task ID", videoTaskId: "Task ID", saveAsset: "Save asset", downloadAudio: "Download audio", downloadVideo: "Download video", downloadImage: "Download image", editTextTitle: "Edit text", editText: "Edit text", decreaseFont: "Decrease font size", increaseFont: "Increase font size", zoomOut: "Smaller", zoomIn: "Larger", uploadImage: "Upload image", replaceVideo: "Replace video", uploadVideo: "Upload video", reverseVideoPrompt: "Infer video prompt", reverseVideoPromptTitle: "Infer a video prompt from key frames and create the text and configuration nodes", productionBoard: "Generate production board", productionBoardTitle: "Create the prompt and configuration nodes for a production board; pick the model and key on the configuration node", renderProductionBoard: "Render board", renderProductionBoardTitle: "Re-render the production board from the analysis JSON in this text node (parse and render only, no model call)", generateVideoFromPrompt: "Generate video from this prompt", generateVideoFromPromptTitle: "Create a video configuration node from this inferred prompt and the production board; pick the model and key there", replaceAudio: "Replace audio", uploadAudio: "Upload audio", nodeInfo: "Node information", name: "Name", type: "Type", size: "Size", position: "Position", status: "Status", imageGroup: "Image group", imageSize: "Image size", group: "Group", groupTitle: "Wrap selected nodes in a group", ungroup: "Ungroup", ungroupTitle: "Remove grouping from selected nodes" },
    ...
    auth: {
        loginTitle: "Log in",
        loginSubtitle: "Log in to manage API keys, usage, and balance",
        registerTitle: "Create account",
        registerSubtitle: "Create an account to generate an API key and start creating",
        email: "Email",
        ...
        verifyCodePlaceholder: "Enter the email verification code",
        sendVerifyCode: "Send code",
        resendVerifyCode: "Resend ({{seconds}}s)",
        verifyCodeSent: "Verification code sent. Check your inbox.",
        sendVerifyCodeFailed: "Failed to send the verification code",
        invitationCode: "Invitation code",
        invitationCodePlaceholder: "Enter the invitation code",
        totpTitle: "Two-factor verification",
        totpSubtitle: "Enter the 6-digit code from your authenticator app",
        totpHint: "Account: {{email}}",
        totpCode: "Code",
        totpCodePlaceholder: "6-digit code",
        totpSubmit: "Verify and log in",
        totpBack: "Back to log in",
        submitLogin: "Log in",
        ...
        registrationClosedHint: "This site is not accepting new registrations right now. Try again later or contact the site administrator.",
        ...
        invitationCodeRequired: "Enter the invitation code",
        verifyCodeRequired: "Enter the email verification code",
        captchaRequired: "Complete the human verification first",
        captchaVerified: "Verified",
        captchaClickToVerify: "Click to verify",
        captchaLoadFailed: "The captcha failed to load. Refresh the page and try again.",
        loginFailed: "Login failed",
        registerFailed: "Registration failed",
        loginSuccess: "Logged in",
        registerSuccess: "Account created",
        settingsFailed: "Failed to load the site configuration. Refresh the page and try again.",
    },
    account: {
        title: "User Center",
        ...
        loginRequiredHint: "Log in to manage API keys and view usage and balance. You can still paste your own API key on the generation pages without logging in.",
        goLogin: "Log in",
        goRegister: "Sign up",
        ...
        overviewBalance: "Account balance",
        overviewBalanceHint: "Balance is accounted for by Sub2API, and media generation tasks deduct from it in real time.",
        overviewCurrentKey: "API key in use",
        overviewCurrentKeyHint: "Generation tasks use this key by default.",
        overviewNoKey: "No API key is available",
        overviewNoKeyHint: "Create an API key to call the API from the generation pages.",
        overviewShortcuts: "Shortcuts",
        manageKeys: "Manage API keys",
        launchGuideHint: "This session came from a Sub2API menu launch. User center, key management, balance, and redemption live on the original site — use it there, or log in with a media account to use the user center here.",
        logoutConfirm: "You will need to log in again to open the user center.",
        overviewTodayRequests: "Requests today",
        overviewTodayCost: "Spent today",
        overviewTotalRequests: "Total requests",
        overviewTotalCost: "Total spent",
        keysTitle: "API Keys",
        keysHint: "Manage the keys used to call the API, and choose which one generation tasks use by default.",
        keysCreate: "New API key",
        keysName: "Name",
        keysNamePlaceholder: "Name this key",
        keysGroup: "Group",
        keysGroupPlaceholder: "Select a group",
        keysStatus: "Status",
        keysQuota: "Quota",
        keysUnlimited: "Unlimited",
        keysCreatedAt: "Created",
        keysLastUsedAt: "Last used",
        keysNever: "Never",
        keysKey: "API Key",
        keysCopy: "Copy",
        ...
        keysCurrent: "In use",
        keysUse: "Use this key",
        keysUseSuccess: "Switched the key used by generation tasks",
        keysUseFailed: "Failed to switch",
        keysDelete: "Delete",
        keysDeleteConfirm: "Calls using this key stop working immediately after deletion. Delete it?",
        keysDeleteSuccess: "API key deleted",
        keysDeleteFailed: "Failed to delete",
        keysCreateSuccess: "API key created",
        keysCreateFailed: "Failed to create",
        keysUpdateSuccess: "API key updated",
        keysUpdateFailed: "Failed to update",
        keysNameRequired: "Enter a name",
        keysStatusActive: "Active",
        keysStatusInactive: "Inactive",
        keysStatusQuotaExhausted: "Quota exhausted",
        keysStatusExpired: "Expired",
        usageTitle: "Usage",
        usageHint: "All usage under your account, including text, chat, image, and video.",
        usageModel: "Model",
        usageModelPlaceholder: "All models",
        usageAPIKeyPlaceholder: "All keys",
        usageReset: "Reset filters",
        usageTime: "Time",
        usageRequests: "Requests",
        usageTokens: "Tokens",
        usageCost: "Actual cost",
        usageStandardCost: "Standard cost",
        usageAmount: "Amount",
        usageEndpoint: "Endpoint",
        usageAPIKey: "API key",
        usageReasoningEffort: "Reasoning effort",
        usageIP: "IP",
        usageGroup: "Group",
        usageRequestType: "Type",
        usageBillingMode: "Billing mode",
        usageLatency: "Latency",
        usageAverageDuration: "Avg. duration",
        usageModelBreakdown: "By model",
        balanceTitle: "Balance",
        balanceHint: "Balance is accounted for by Sub2API; granted credits are consumed in order of expiry.",
        balanceAvailable: "Available balance",
        balanceFrozen: "Frozen",
        balanceCredits: "Granted credits",
        balanceCreditsEmpty: "No granted credits",
        balanceCreditSource: "Source",
        balanceCreditSourceRedeem: "Redeem code",
        balanceCreditSourceAdmin: "Granted by admin",
        balanceCreditAmount: "Amount",
        balanceCreditRemaining: "Remaining",
        balanceCreditExpires: "Expires",
        balanceCreditNeverExpires: "Never",
        balanceCreditStatus: "Status",
        balanceCreditStatusActive: "Active",
        balanceCreditStatusConsumed: "Used up",
        balanceCreditStatusExpired: "Expired",
        redeemTitle: "Redeem code",
        redeemHint: "Redeem a code to top up balance or concurrency. Your redemption history is kept below.",
        redeemCodePlaceholder: "Enter the redeem code",
        redeemSubmit: "Redeem",
        redeemSuccess: "Redeemed successfully. You received {{value}}.",
        redeemFailed: "Redemption failed",
        redeemCodeRequired: "Enter a redeem code",
        redeemConfirm: "A redeemed code cannot be reversed. Redeem it now?",
        redeemPurchase: "Buy a redeem code",
        redeemPurchaseHint: "Buy from the official store, then redeem it here.",
        redeemHistory: "Redemption history",
        redeemHistoryEmpty: "No redemptions yet",
        redeemHistoryCode: "Code",
        redeemHistoryValue: "Received",
        redeemHistoryStatus: "Status",
        redeemHistoryUsed: "Redeemed",
        redeemHistoryUsedAt: "Redeemed at",
        redeemHistoryCreatedAt: "Created at",
